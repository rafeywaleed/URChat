...
class NotificationService {
  ...
  void _setupMessageHandling() {
    FirebaseMessaging.onMessage.listen((message) {
      ...
      // Only process if app is in background
      if (_isAppInBackground) {
        print('📱 App is in background - processing notification');
        _handleIncomingMessage(message);
      } else {
        print('📱 App is in foreground - IGNORING notification completely');
        // Do nothing - no storing, no showing, no processing
        return;
      }
    });
  ...
  Future<void> _handleIncomingMessage(RemoteMessage message) async {
    ...
    print('💬 Processing message for: $chatName ($chatId)');
